...
import { JWT_ACCESS_SECRET } from 'src/constants/environment';
import { accessTokenLifeTime, refreshTokenLifeTime } from 'src/constants/permanent';
...
export class TokenService {
    ...
    async refresh(token: string): Promise<InfoAndTokens> {
        ...
        await this.tokenRepository.saveUserToken(generatedTokens.refreshToken, payload);
